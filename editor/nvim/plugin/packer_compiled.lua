...
_G.packer_plugins = {
  ...
  ["telekasten.nvim"] = {
    loaded = true,
    path = "/Users/brandonmorimoto/.local/share/nvim/site/pack/packer/start/telekasten.nvim",
  ...
  ["vim-slash"] = {
    loaded = true,
    path = "/Users/brandonmorimoto/.local/share/nvim/site/pack/packer/start/vim-slash",
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'bullets.vim', 'vim-markdown-toc', 'vim-markdown', 'vim-table-mode', 'markdown-preview.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
