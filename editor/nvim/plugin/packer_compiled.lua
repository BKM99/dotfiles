...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'bullets.vim', 'zk-nvim', 'vim-table-mode', 'vim-markdown-toc', 'vim-markdown', 'mkdnflow.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
