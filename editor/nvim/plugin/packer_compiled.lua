...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'follow-md-links.nvim', 'vim-markdown-toc', 'bullets.vim', 'markdown-preview.nvim', 'zk-nvim', 'vim-table-mode'}, { ft = "markdown" }, _G.packer_plugins)]]
