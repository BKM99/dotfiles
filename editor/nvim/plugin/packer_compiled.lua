...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'markdown-preview.nvim', 'vim-markdown-toc', 'follow-md-links.nvim', 'bullets.vim', 'zk-nvim', 'vim-table-mode'}, { ft = "markdown" }, _G.packer_plugins)]]
