...
_G.packer_plugins = {
  ...
  ["git-messenger.vim"] = {
    loaded = true,
    path = "/Users/brandonmorimoto/.local/share/nvim/site/pack/packer/start/git-messenger.vim",
  ...
  ["lua-dev.nvim"] = {
    loaded = true,
    path = "/Users/brandonmorimoto/.local/share/nvim/site/pack/packer/start/lua-dev.nvim",
  ...
  playground = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/Users/brandonmorimoto/.local/share/nvim/site/pack/packer/opt/playground",
  ...
  ["project.nvim"] = {
    config = { "\27LJ\2\nN\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\1K\0\1\0\1\0\1\16manual_mode\1\nsetup\17project_nvim\frequire\0" },
    loaded = true,
  ...
  ["vim-markdown"] = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/Users/brandonmorimoto/.local/share/nvim/site/pack/packer/opt/vim-markdown",
  ...
  ["vim-sleuth"] = {
    loaded = true,
    path = "/Users/brandonmorimoto/.local/share/nvim/site/pack/packer/start/vim-sleuth",
...
try_loadstring("\27LJ\2\no\0\0\6\0\a\0\t6\0\0\0009\0\1\0009\0\2\0'\2\3\0'\3\4\0'\4\5\0005\5\6\0B\0\5\1K\0\1\0\1\0\2\vsilent\2\fnoremap\2\24:UndotreeToggle<CR>\15<leader>ut\6n\bset\vkeymap\bvim\0", "setup", "undotree")
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'mkdnflow.nvim', 'markdown-preview.nvim', 'bullets.vim', 'zk-nvim', 'vim-table-mode', 'vim-markdown-toc', 'vim-markdown'}, { ft = "markdown" }, _G.packer_plugins)]]
