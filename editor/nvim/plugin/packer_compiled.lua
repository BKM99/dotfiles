...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-table-mode', 'markdown-preview.nvim', 'bullets.vim', 'mkdnflow.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
