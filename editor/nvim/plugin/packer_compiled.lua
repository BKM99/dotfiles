...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'mkdnflow.nvim', 'zk-nvim', 'vim-table-mode', 'vim-markdown-toc', 'vim-markdown', 'bullets.vim'}, { ft = "markdown" }, _G.packer_plugins)]]
