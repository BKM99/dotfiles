...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-table-mode', 'vim-markdown-toc', 'vim-markdown', 'mkdnflow.nvim', 'zk-nvim', 'bullets.vim'}, { ft = "markdown" }, _G.packer_plugins)]]
