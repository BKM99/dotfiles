...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-table-mode', 'follow-md-links.nvim', 'vim-markdown-toc', 'bullets.vim', 'markdown-preview.nvim', 'zk-nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
