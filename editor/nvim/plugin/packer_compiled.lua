...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'markdown-preview.nvim', 'bullets.vim', 'vim-table-mode', 'mkdnflow.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
