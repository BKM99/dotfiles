...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'bullets.vim', 'vim-markdown', 'vim-table-mode', 'markdown-preview.nvim', 'vim-markdown-toc'}, { ft = "markdown" }, _G.packer_plugins)]]
