...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'markdown-preview.nvim', 'vim-markdown-toc', 'vim-table-mode', 'vim-markdown', 'bullets.vim'}, { ft = "markdown" }, _G.packer_plugins)]]
