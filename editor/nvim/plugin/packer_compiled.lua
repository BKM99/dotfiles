...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-markdown-toc', 'markdown-preview.nvim', 'follow-md-links.nvim', 'zk-nvim', 'bullets.vim', 'vim-table-mode'}, { ft = "markdown" }, _G.packer_plugins)]]
