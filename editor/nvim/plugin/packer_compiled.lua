...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'zk-nvim', 'mkdnflow.nvim', 'vim-table-mode', 'vim-markdown-toc', 'vim-markdown', 'markdown-preview.nvim', 'bullets.vim'}, { ft = "markdown" }, _G.packer_plugins)]]
