...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-table-mode', 'markdown-preview.nvim', 'vim-markdown-toc', 'bullets.vim', 'follow-md-links.nvim', 'zk-nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
