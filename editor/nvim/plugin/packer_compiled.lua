...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'zk-nvim', 'markdown-preview.nvim', 'follow-md-links.nvim', 'bullets.vim', 'vim-markdown-toc', 'vim-table-mode'}, { ft = "markdown" }, _G.packer_plugins)]]
