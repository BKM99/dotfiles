...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'markdown-preview.nvim', 'follow-md-links.nvim', 'vim-table-mode', 'bullets.vim', 'zk-nvim', 'vim-markdown-toc'}, { ft = "markdown" }, _G.packer_plugins)]]
