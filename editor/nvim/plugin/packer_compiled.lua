...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'zk-nvim', 'bullets.vim', 'vim-table-mode', 'mkdnflow.nvim', 'markdown-preview.nvim', 'vim-markdown', 'vim-markdown-toc'}, { ft = "markdown" }, _G.packer_plugins)]]
