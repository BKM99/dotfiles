...
_G.packer_plugins = {
  ...
  ["alpha-nvim"] = {
    loaded = true,
    path = "/Users/brandonmorimoto/.local/share/nvim/site/pack/packer/start/alpha-nvim",
  ...
  ["filetype.nvim"] = {
    loaded = true,
    path = "/Users/brandonmorimoto/.local/share/nvim/site/pack/packer/start/filetype.nvim",
  ...
  ["git-blame.nvim"] = {
    loaded = true,
    needs_bufread = false,
    path = "/Users/brandonmorimoto/.local/share/nvim/site/pack/packer/opt/git-blame.nvim",
  ...
  ["nvim-dap-virtual-text"] = {
    loaded = true,
    path = "/Users/brandonmorimoto/.local/share/nvim/site/pack/packer/start/nvim-dap-virtual-text",
  ...
  ["nvim-notify"] = {
    loaded = true,
    path = "/Users/brandonmorimoto/.local/share/nvim/site/pack/packer/start/nvim-notify",
  ...
  ["one-small-step-for-vimkind"] = {
    loaded = true,
    path = "/Users/brandonmorimoto/.local/share/nvim/site/pack/packer/start/one-small-step-for-vimkind",
  ...
  playground = {
    loaded = true,
    path = "/Users/brandonmorimoto/.local/share/nvim/site/pack/packer/start/playground",
  ...
  ["registers.nvim"] = {
    loaded = true,
    needs_bufread = false,
    path = "/Users/brandonmorimoto/.local/share/nvim/site/pack/packer/opt/registers.nvim",
  ...
  ["symbols-outline.nvim"] = {
    loaded = true,
    path = "/Users/brandonmorimoto/.local/share/nvim/site/pack/packer/start/symbols-outline.nvim",
  ...
  ["typescript.nvim"] = {
    loaded = true,
    path = "/Users/brandonmorimoto/.local/share/nvim/site/pack/packer/start/typescript.nvim",
  ...
  ["vim-markdown"] = {
    loaded = true,
    path = "/Users/brandonmorimoto/.local/share/nvim/site/pack/packer/start/vim-markdown",
