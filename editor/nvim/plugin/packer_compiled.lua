...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-markdown-toc', 'follow-md-links.nvim', 'bullets.vim', 'markdown-preview.nvim', 'zk-nvim', 'vim-table-mode'}, { ft = "markdown" }, _G.packer_plugins)]]
