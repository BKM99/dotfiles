...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'markdown-preview.nvim', 'zk-nvim', 'vim-markdown-toc', 'follow-md-links.nvim', 'bullets.vim', 'vim-table-mode'}, { ft = "markdown" }, _G.packer_plugins)]]
