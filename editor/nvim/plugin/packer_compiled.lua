...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'bullets.vim', 'zk-nvim', 'vim-markdown-toc', 'vim-markdown', 'markdown-preview.nvim', 'mkdnflow.nvim', 'vim-table-mode'}, { ft = "markdown" }, _G.packer_plugins)]]
