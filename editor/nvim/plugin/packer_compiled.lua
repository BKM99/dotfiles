...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'zk-nvim', 'vim-table-mode', 'markdown-preview.nvim', 'vim-markdown-toc', 'follow-md-links.nvim', 'bullets.vim'}, { ft = "markdown" }, _G.packer_plugins)]]
