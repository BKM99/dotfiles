...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'zk-nvim', 'markdown-preview.nvim', 'vim-table-mode', 'vim-markdown-toc', 'follow-md-links.nvim', 'bullets.vim'}, { ft = "markdown" }, _G.packer_plugins)]]
