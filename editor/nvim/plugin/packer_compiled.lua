...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'mkdnflow.nvim', 'markdown-preview.nvim', 'vim-markdown', 'bullets.vim', 'vim-table-mode', 'zk-nvim', 'vim-markdown-toc'}, { ft = "markdown" }, _G.packer_plugins)]]
