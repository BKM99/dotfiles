...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'mkdnflow.nvim', 'markdown-preview.nvim', 'vim-table-mode', 'vim-markdown', 'bullets.vim', 'zk-nvim', 'vim-markdown-toc'}, { ft = "markdown" }, _G.packer_plugins)]]
