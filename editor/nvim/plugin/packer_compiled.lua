...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'bullets.vim', 'zk-nvim', 'vim-table-mode', 'vim-markdown', 'mkdnflow.nvim', 'markdown-preview.nvim', 'vim-markdown-toc'}, { ft = "markdown" }, _G.packer_plugins)]]
